          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-[1.6rem] font-black leading-[1.15] tracking-tight sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl">
              ...
              <span className="block bg-gradient-to-r from-sky-300 via-cyan-300 to-teal-300 bg-clip-text text-transparent">
                Białołęka, Marki,<br className="sm:hidden" /> Legionowo i okolice
              </span>
            </h1>
            ...
            <div className="mt-5 flex flex-col justify-center gap-2.5 sm:mt-6 sm:flex-row sm:flex-wrap sm:gap-3 lg:mt-8 lg:justify-start">
              <a
              ...
              <a
                href="#kontakt"
                className="inline-flex items-center justify-center gap-1.5 rounded-full border border-white/10 bg-transparent px-5 py-3 text-sm text-white/60 transition hover:text-white sm:px-6"
              >
                Napisz do nas
              ...
              {status === "sent" ? (
                ...
                >
                  ...
                  <p className="mt-3 text-center text-[10px] text-white/40 sm:text-xs">
                    Dzwoń pn–pt 9:00–18:00 • Bezpłatna wycena • Dane chronione RODO
                  </p>
                </form>
              )}
            </div>
